 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Uy;function g9(){return Uy||(Uy=1,function(e){function t(X,le){var ue=X.length;X.push(le);e:for(;0<ue;){var xe=ue-1>>>1,P=X[xe];if(0<o(P,le))X[xe]=le,X[ue]=P,ue=xe;else break e}}function i(X){return X.length===0?null:X[0]}function a(X){if(X.length===0)return null;var le=X[0],ue=X.pop();if(ue!==le){X[0]=ue;e:for(var xe=0,P=X.length,re=P>>>1;xe<re;){var we=2*(xe+1)-1,be=X[we],Re=we+1,$e=X[Re];if(0>o(be,ue))Re<P&&0>o($e,be)?(X[xe]=$e,X[Re]=ue,xe=Re):(X[xe]=be,X[we]=ue,xe=we);else if(Re<P&&0>o($e,ue))X[xe]=$e,X[Re]=ue,xe=Re;else break e}}return le}function o(X,le){var ue=X.sortIndex-le.sortIndex;return ue!==0?ue:X.id-le.id}if(e.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;e.unstable_now=function(){return c.now()}}else{var f=Date,h=f.now();e.unstable_now=function(){return f.now()-h}}var p=[],g=[],y=1,b=null,S=3,A=!1,T=!1,L=!1,_=!1,k=typeof setTimeout=="function"?setTimeout:null,O=typeof clearTimeout=="function"?clearTimeout:null,R=typeof setImmediate<"u"?setImmediate:null;function B(X){for(var le=i(g);le!==null;){if(le.callback===null)a(g);else if(le.startTime<=X)a(g),le.sortIndex=le.expirationTime,t(p,le);else break;le=i(g)}}function H(X){if(L=!1,B(X),!T)if(i(p)!==null)T=!0,Y||(Y=!0,ye());else{var le=i(g);le!==null&&Ae(H,le.startTime-X)}}var Y=!1,G=-1,Q=5,ie=-1;function se(){return _?!0:!(e.unstable_now()-ie<Q)}function de(){if(_=!1,Y){var X=e.unstable_now();ie=X;var le=!0;try{e:{T=!1,L&&(L=!1,O(G),G=-1),A=!0;var ue=S;try{t:{for(B(X),b=i(p);b!==null&&!(b.expirationTime>X&&se());){var xe=b.callback;if(typeof xe=="function"){b.callback=null,S=b.priorityLevel;var P=xe(b.expirationTime<=X);if(X=e.unstable_now(),typeof P=="function"){b.callback=P,B(X),le=!0;break t}b===i(p)&&a(p),B(X)}else a(p);b=i(p)}if(b!==null)le=!0;else{var re=i(g);re!==null&&Ae(H,re.startTime-X),le=!1}}break e}finally{b=null,S=ue,A=!1}le=void 0}}finally{le?ye():Y=!1}}}var ye;if(typeof R=="function")ye=function(){R(de)};else if(typeof MessageChannel<"u"){var Ee=new MessageChannel,Oe=Ee.port2;Ee.port1.onmessage=de,ye=function(){Oe.postMessage(null)}}else ye=function(){k(de,0)};function Ae(X,le){G=k(function(){X(e.unstable_now())},le)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(X){X.callback=null},e.unstable_forceFrameRate=function(X){0>X||125<X?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Q=0<X?Math.floor(1e3/X):5},e.unstable_getCurrentPriorityLevel=function(){return S},e.unstable_next=function(X){switch(S){case 1:case 2:case 3:var le=3;break;default:le=S}var ue=S;S=le;try{return X()}finally{S=ue}},e.unstable_requestPaint=function(){_=!0},e.unstable_runWithPriority=function(X,le){switch(X){case 1:case 2:case 3:case 4:case 5:break;default:X=3}var ue=S;S=X;try{return le()}finally{S=ue}},e.unstable_scheduleCallback=function(X,le,ue){var xe=e.unstable_now();switch(typeof ue=="object"&&ue!==null?(ue=ue.delay,ue=typeof ue=="number"&&0<ue?xe+ue:xe):ue=xe,X){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=ue+P,X={id:y++,callback:le,priorityLevel:X,startTime:ue,expirationTime:P,sortIndex:-1},ue>xe?(X.sortIndex=ue,t(g,X),i(p)===null&&X===i(g)&&(L?(O(G),G=-1):L=!0,Ae(H,ue-xe))):(X.sortIndex=P,t(p,X),T||A||(T=!0,Y||(Y=!0,ye()))),X},e.unstable_shouldYield=se,e.unstable_wrapCallback=function(X){var le=S;return function(){var ue=S;S=le;try{return X.apply(this,arguments)}finally{S=ue}}}}(qg)),qg}var $y;function x9(){return $y||($y=1,Gg.exports=g9()),Gg.exports}var Fg={exports:{}},Fe={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Gy;function v9(){if(Gy)return Fe;Gy=1;var e=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),f=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),g=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),b=Symbol.iterator;function S(P){return P===null||typeof P!="object"?null:(P=b&&P[b]||P["@@iterator"],typeof P=="function"?P:null)}var A={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},T=Object.assign,L={};function _(P,re,we){this.props=P,this.context=re,this.refs=L,this.updater=we||A}_.prototype.isReactComponent={},_.prototype.setState=function(P,re){if(typeof P!="object"&&typeof P!="function"&&P!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,P,re,"setState")},_.prototype.forceUpdate=function(P){this.updater.enqueueForceUpdate(this,P,"forceUpdate")};function k(){}k.prototype=_.prototype;function O(P,re,we){this.props=P,this.context=re,this.refs=L,this.updater=we||A}var R=O.prototype=new k;R.constructor=O,T(R,_.prototype),R.isPureReactComponent=!0;var B=Array.isArray,H={H:null,A:null,T:null,S:null,V:null},Y=Object.prototype.hasOwnProperty;function G(P,re,we,be,Re,$e){return we=$e.ref,{$$typeof:e,type:P,key:re,ref:we!==void 0?we:null,props:$e}}function Q(P,re){return G(P.type,re,void 0,void 0,void 0,P.props)}function ie(P){return typeof P=="object"&&P!==null&&P.$$typeof===e}function se(P){var re={"=":"=0",":":"=2"};return"$"+P.replace(/[=:]/g,function(we){return re[we]})}var de=/\/+/g;function ye(P,re){return typeof P=="object"&&P!==null&&P.key!=null?se(""+P.key):re.toString(36)}function Ee(){}function Oe(P){switch(P.status){case"fulfilled":return P.value;case"rejected":throw P.reason;default:switch(typeof P.status=="string"?P.then(Ee,Ee):(P.status="pending",P.then(function(re){P.status==="pending"&&(P.status="fulfilled",P.value=re)},function(re){P.status==="pending"&&(P.status="rejected",P.reason=re)})),P.status){case"fulfilled":return P.value;case"rejected":throw P.reason}}throw P}function Ae(P,re,we,be,Re){var $e=typeof P;($e==="undefined"||$e==="boolean")&&(P=null);var ke=!1;if(P===null)ke=!0;else switch($e){case"bigint":case"string":case"number":ke=!0;break;case"object":switch(P.$$typeof){case e:case t:ke=!0;break;case y:return ke=P._init,Ae(ke(P._payload),re,we,be,Re)}}if(ke)return Re=Re(P),ke=be===""?"."+ye(P,0):be,B(Re)?(we="",ke!=null&&(we=ke.replace(de,"$&/")+"/"),Ae(Re,re,we,"",function(Yt){return Yt})):Re!=null&&(ie(Re)&&(Re=Q(Re,we+(Re.key==null||P&&P.key===Re.key?"":(""+Re.key).replace(de,"$&/")+"/")+ke)),re.push(Re)),1;ke=0;var sn=be===""?".":be+":";if(B(P))for(var it=0;it<P.length;it++)be=P[it],$e=sn+ye(be,it),ke+=Ae(be,re,we,$e,Re);else if(it=S(P),typeof it=="function")for(P=it.call(P),it=0;!(be=P.next()).done;)be=be.value,$e=sn+ye(be,it++),ke+=Ae(be,re,we,$e,Re);else if($e==="object"){if(typeof P.then=="function")return Ae(Oe(P),re,we,be,Re);throw re=String(P),Error("Objects are not valid as a React child (found: "+(re==="[object Object]"?"object with keys {"+Object.keys(P).join(", ")+"}":re)+"). If you meant to render a collection of children, use an array instead.")}return ke}function X(P,re,we){if(P==null)return P;var be=[],Re=0;return Ae(P,be,"","",function($e){return re.call(we,$e,Re++)}),be}function le(P){if(P._status===-1){var re=P._result;re=re(),re.then(function(we){(P._status===0||P._status===-1)&&(P._status=1,P._result=we)},function(we){(P._status===0||P._status===-1)&&(P._status=2,P._result=we)}),P._status===-1&&(P._status=0,P._result=re)}if(P._status===1)return P._result.default;throw P._result}var ue=typeof reportError=="function"?reportError:function(P){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var re=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof P=="object"&&P!==null&&typeof P.message=="string"?String(P.message):String(P),error:P});if(!window.dispatchEvent(re))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",P);return}console.error(P)};function xe(){}return Fe.Children={map:X,forEach:function(P,re,we){X(P,function(){re.apply(this,arguments)},we)},count:function(P){var re=0;return X(P,function(){re++}),re},toArray:function(P){return X(P,function(re){return re})||[]},only:function(P){if(!ie(P))throw Error("React.Children.only expected to receive a single React element child.");return P}},Fe.Component=_,Fe.Fragment=i,Fe.Profiler=o,Fe.PureComponent=O,Fe.StrictMode=a,Fe.Suspense=p,Fe.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=H,Fe.__COMPILER_RUNTIME={__proto__:null,c:function(P){return H.H.useMemoCache(P)}},Fe.cache=function(P){return function(){return P.apply(null,arguments)}},Fe.cloneElement=function(P,re,we){if(P==null)throw Error("The argument must be a React element, but you passed "+P+".");var be=T({},P.props),Re=P.key,$e=void 0;if(re!=null)for(ke in re.ref!==void 0&&($e=void 0),re.key!==void 0&&(Re=""+re.key),re)!Y.call(re,ke)||ke==="key"||ke==="__self"||ke==="__source"||ke==="ref"&&re.ref===void 0||(be[ke]=re[ke]);var ke=arguments.length-2;if(ke===1)be.children=we;else if(1<ke){for(var sn=Array(ke),it=0;it<ke;it++)sn[it]=arguments[it+2];be.children=sn}return G(P.type,Re,void 0,void 0,$e,be)},Fe.createContext=function(P){return P={$$typeof:f,_currentValue:P,_currentValue2:P,_threadCount:0,Provider:null,Consumer:null},P.Provider=P,P.Consumer={$$typeof:c,_context:P},P},Fe.createElement=function(P,re,we){var be,Re={},$e=null;if(re!=null)for(be in re.key!==void 0&&($e=""+re.key),re)Y.call(re,be)&&be!=="key"&&be!=="__self"&&be!=="__source"&&(Re[be]=re[be]);var ke=arguments.length-2;if(ke===1)Re.children=we;else if(1<ke){for(var sn=Array(ke),it=0;it<ke;it++)sn[it]=arguments[it+2];Re.children=sn}if(P&&P.defaultProps)for(be in ke=P.defaultProps,ke)Re[be]===void 0&&(Re[be]=ke[be]);return G(P,$e,void 0,void 0,null,Re)},Fe.createRef=function(){return{current:null}},Fe.forwardRef=function(P){return{$$typeof:h,render:P}},Fe.isValidElement=ie,Fe.lazy=function(P){return{$$typeof:y,_payload:{_status:-1,_result:P},_init:le}},Fe.memo=function(P,re){return{$$typeof:g,type:P,compare:re===void 0?null:re}},Fe.startTransition=function(P){var re=H.T,we={};H.T=we;try{var be=P(),Re=H.S;Re!==null&&Re(we,be),typeof be=="object"&&be!==null&&typeof be.then=="function"&&be.then(xe,ue)}catch($e){ue($e)}finally{H.T=re}},Fe.unstable_useCacheRefresh=function(){return H.H.useCacheRefresh()},Fe.use=function(P){return H.H.use(P)},Fe.useActionState=function(P,re,we){return H.H.useActionState(P,re,we)},Fe.useCallback=function(P,re){return H.H.useCallback(P,re)},Fe.useContext=function(P){return H.H.useContext(P)},Fe.useDebugValue=function(){},Fe.useDeferredValue=function(P,re){return H.H.useDeferredValue(P,re)},Fe.useEffect=function(P,re,we){var be=H.H;if(typeof we=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return be.useEffect(P,re)},Fe.useId=function(){return H.H.useId()},Fe.useImperativeHandle=function(P,re,we){return H.H.useImperativeHandle(P,re,we)},Fe.useInsertionEffect=function(P,re){return H.H.useInsertionEffect(P,re)},Fe.useLayoutEffect=function(P,re){return H.H.useLayoutEffect(P,re)},Fe.useMemo=function(P,re){return H.H.useMemo(P,re)},Fe.useOptimistic=function(P,re){return H.H.useOptimistic(P,re)},Fe.useReducer=function(P,re,we){return H.H.useReducer(P,re,we)},Fe.useRef=function(P){return H.H.useRef(P)},Fe.useState=function(P){return H.H.useState(P)},Fe.useSyncExternalStore=function(P,re,we){return H.H.useSyncExternalStore(P,re,we)},Fe.useTransition=function(){return H.H.useTransition()},Fe.version="19.1.1",Fe}var qy;function J3(){return qy||(qy=1,Fg.exports=v9()),Fg.exports}var Yg={exports:{}},Jn={};/**
 * @license React
...
`,tV=M.button`
  ...
  padding: 0;
  margin-left: 12px;
`,nV=({type:e,message:t,onClose:i,autoClose:a=!0,autoCloseDuration:o=25e3})=>{const{t:c}=ay();N.useEffect(()=>{if(a){const h=setTimeout(()=>{i()},o);return()=>clearTimeout(h)}},[a,o,i]);const f={success:c("alert.success"),error:c("alert.error")};return x.jsxs(eV,{$type:e,initial:{x:300,opacity:0},animate:{x:0,opacity:1},exit:{x:300,opacity:0},transition:{type:"spring",damping:25},children:[x.jsx("div",{children:t||f[e]}),x.jsx(tV,{onClick:i,children:"×"})]})},iV="/assets/contact-39wCMyse.webp",S2=()=>{const[e,t]=N.useState(""),[i,a]=N.useState({name:"",email:"",phone:"",location:"",appliance:"",brand:"",power:"",details:""}),[o,c]=N.useState({}),[f,h]=N.useState(null),[p,g]=N.useState(!1),[y,b]=N.useState(!1),S=()=>{g(!0)},A=()=>{g(!1)},T=H=>{const{name:Y,value:G}=H.target;a(Q=>({...Q,[Y]:G})),c(Q=>({...Q,[Y]:!1}))},L=()=>{const H={};return e||(H.service=!0),i.name||(H.name=!0),i.email||(H.email=!0),i.phone||(H.phone=!0),i.location||(H.location=!0),H},_=async H=>{H.preventDefault();const Y=L();if(Object.keys(Y).length>0){c(Y),h({type:"error",message:"Please fill all required fields"});return}try{if((await fetch("/.netlify/functions/send-email",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({service:e,...i})})).ok)t(""),a({name:"",email:"",phone:"",location:"",appliance:"",brand:"",power:"",details:""}),c({}),h({type:"success",message:"Form submitted successfully! We will contact you soon."});else throw new Error("Failed to submit form")}catch(G){console.error("Error submitting form:",G),h({type:"error",message:"There was an error submitting the form. Please try again."})}},k={hidden:{opacity:0,y:20},visible:{opacity:1,y:0,transition:{duration:.5,ease:ve}}},O={hidden:{opacity:0,y:30},visible:{opacity:1,y:0,transition:{duration:.4,ease:ve}}},R={hidden:{opacity:0,x:-10},visible:{opacity:1,x:0,transition:{duration:.3,ease:ve}},focus:{scale:1.01,transition:{duration:.1}}},B={hidden:{opacity:0,scale:.95},visible:{opacity:1,scale:1,transition:{duration:.3,ease:ve}},hover:{scale:1.02,transition:{duration:.1}},tap:{scale:.98}};return x.jsxs(x.Fragment,{children:[x.jsxs(cV,{children:[x.jsxs(pw,{children:[x.jsxs(Vx,{children:[x.jsx(W.div,{initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2},variants:k,children:x.jsxs(uV,{children:[" ",x.jsx("span",{children:"Contact"})," our team"]})}),x.jsx(W.div,{initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2},variants:k,transition:{delay:.1},children:x.jsx(im,{children:"We love our customers, so feel free to call during normal business hours"})})]})," ",x.jsx(W.div,{variants:B,initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2},whileHover:"hover",whileTap:"tap",children:x.jsx("a",{href:"tel:+18055002705",children:x.jsx(dV,{children:x.jsx(fV,{children:"Call Us for Fast Repair"})})})}),x.jsxs(pw,{children:[x.jsx(hV,{}),x.jsxs(pV,{children:[x.jsxs(mw,{width:"251px",children:[x.jsx(W.div,{initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2},variants:k,children:x.jsx(gw,{children:"Service Hours"})}),x.jsx(Vx,{children:x.jsx(W.div,{initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2},variants:k,transition:{delay:.2},children:x.jsxs(im,{children:["Mon–Sat: 8AM–6PM ",x.jsx("br",{})," Sun: 9AM–4PM"," "]})})})]}),x.jsxs(mw,{children:[x.jsx(W.div,{initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2},variants:k,transition:{delay:.3},children:x.jsx(gw,{children:"Our Location"})}),x.jsxs(Vx,{children:[x.jsx(W.div,{initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2},variants:k,transition:{delay:.4},children:x.jsxs("a",{href:"https://maps.app.goo.gl/cJF4BwHPJFbYsQAMA",target:"_blank",rel:"noopener noreferrer",children:[" ",x.jsx(im,{children:" 801 Tioga Pl, Newbury Park, CA 91320"})]})}),x.jsx(W.div,{initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2},variants:k,transition:{delay:.5},children:x.jsx("a",{href:"tel:+18055002705",children:x.jsx(im,{children:"+1 (805) 500-2705"})})})]})]})]})]})]}),x.jsx(W.div,{variants:O,initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2},children:x.jsxs(aV,{onSubmit:_,children:[x.jsx(W.div,{initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},transition:{duration:.4,ease:ve},children:x.jsx(mV,{src:iV,alt:"contact image",onLoad:()=>b(!0),style:{opacity:y?1:0,transition:"opacity 0.3s ease"}})}),x.jsx(hs,{children:"What service do you need for your appliances?"}),x.jsxs(rV,{children:[x.jsx(W.div,{variants:R,whileHover:"hover",children:x.jsxs(dw,{style:o.service?{borderColor:"red"}:{},children:[x.jsx(fw,{name:"service",value:"Repair",checked:e==="Repair",onChange:H=>t(H.target.value)}),x.jsx(hw,{checked:e==="Repair"}),"Repair"]})}),x.jsx(W.div,{variants:R,transition:{delay:.1},whileHover:"hover",children:x.jsxs(dw,{style:o.service?{borderColor:"red"}:{},children:[x.jsx(fw,{name:"service",value:"Installation",checked:e==="Installation",onChange:H=>t(H.target.value)}),x.jsx(hw,{checked:e==="Installation"}),"Installation"]})})]}),x.jsxs(gV,{children:[x.jsxs(xV,{children:[x.jsx(hs,{children:"Name"}),x.jsx(W.div,{variants:R,transition:{delay:.2},whileFocus:"focus",children:x.jsx(Dx,{name:"name",type:"text",placeholder:"Your Name",value:i.name,onChange:T,style:o.name?{borderBottom:"1px solid red"}:{}})}),x.jsx(hs,{children:"Email"}),x.jsx(W.div,{variants:R,transition:{delay:.3},whileFocus:"focus",children:x.jsx(Dx,{name:"email",type:"email",placeholder:"Your Email",value:i.email,onChange:T,style:o.email?{borderBottom:"1px solid red"}:{}})}),x.jsx(hs,{children:"Phone Number"}),x.jsx(W.div,{variants:R,transition:{delay:.4},whileFocus:"focus",children:x.jsx(Dx,{name:"phone",type:"tel",placeholder:"Your Phone Number",value:i.phone,onChange:T,style:o.phone?{borderBottom:"1px solid red"}:{}})})]}),x.jsxs(vV,{children:[x.jsx(hs,{children:"In what location do you need the service?"}),x.jsx(W.div,{variants:R,transition:{delay:.5},whileFocus:"focus",children:x.jsx(tm,{children:x.jsxs(nm,{name:"location",value:i.location,onChange:T,style:o.location?{borderBottom:"1px solid red"}:{},children:[x.jsx("option",{value:"",children:"Select location"}),x.jsx("option",{children:"Agoura Hills"}),x.jsx("option",{children:"Calabasas"}),x.jsx("option",{children:"Camarillo"}),x.jsx("option",{children:"Hidden Valley"}),x.jsx("option",{children:"Lake Sherwood"}),x.jsx("option",{children:"Los Angeles County"}),x.jsx("option",{children:"Malibu"}),x.jsx("option",{children:"Moorpark"}),x.jsx("option",{children:"Newbury Park"}),x.jsx("option",{children:"Oak Park"}),x.jsx("option",{children:"Santa Rosa Valley"}),x.jsx("option",{children:"Thousand Oaks"}),x.jsx("option",{children:"Westlake Village"}),x.jsx("option",{children:"Other"})]})})}),x.jsx(hs,{children:"What do you need repaired?"}),x.jsx(W.div,{variants:R,transition:{delay:.6},whileFocus:"focus",children:x.jsx(tm,{children:x.jsxs(nm,{name:"appliance",value:i.appliance,onChange:T,style:o.appliance?{borderBottom:"1px solid red"}:{},children:[x.jsx("option",{value:"",children:"Select appliance"}),x.jsx("option",{children:"Refrigerator"}),x.jsx("option",{children:"Dryer"}),x.jsx("option",{children:"Oven"}),x.jsx("option",{children:"Ice Maker"}),x.jsx("option",{children:"Washer"}),x.jsx("option",{children:"Range"}),x.jsx("option",{children:"Wine Cooler"}),x.jsx("option",{children:"Freezer"}),x.jsx("option",{children:"Air Conditioner"}),x.jsx("option",{children:"Furnace"}),x.jsx("option",{children:"Other"})]})})}),x.jsx(hs,{children:"Brand of appliance"}),x.jsx(W.div,{variants:R,transition:{delay:.7},whileFocus:"focus",children:x.jsx(tm,{children:x.jsxs(nm,{name:"brand",value:i.brand,onChange:T,style:o.brand?{borderBottom:"1px solid red"}:{},children:[x.jsx("option",{value:"",children:"Select brand"}),x.jsx("option",{children:"Amana"}),x.jsx("option",{children:"Bosch"}),x.jsx("option",{children:"Electrolux"}),x.jsx("option",{children:"Fisher & Paykel"}),x.jsx("option",{children:"Frigidaire"}),x.jsx("option",{children:"GE"}),x.jsx("option",{children:"Haier"}),x.jsx("option",{children:"JennAir"}),x.jsx("option",{children:"KitchenAid"}),x.jsx("option",{children:"LG"}),x.jsx("option",{children:"Maytag"}),x.jsx("option",{children:"Samsung"}),x.jsx("option",{children:"Sharp"}),x.jsx("option",{children:"Sub-Zero"}),x.jsx("option",{children:"Thermador"}),x.jsx("option",{children:"Viking"}),x.jsx("option",{children:"Whirlpool"}),x.jsx("option",{children:"Wolf"}),x.jsx("option",{children:"Other"})]})})})]})]}),x.jsx(hs,{children:"What type of power does this appliance use?"}),x.jsx(W.div,{variants:R,transition:{delay:.8},whileFocus:"focus",children:x.jsx(tm,{children:x.jsxs(nm,{name:"power",value:i.power,onChange:T,style:o.power?{borderBottom:"1px solid red"}:{},children:[x.jsx("option",{value:"",children:"Select power"}),x.jsx("option",{children:"Electric"}),x.jsx("option",{children:"Natural Gas"}),x.jsx("option",{children:"Propane"})]})})}),x.jsx(hs,{children:"Any details you'd like to add?"}),x.jsx(W.div,{variants:R,transition:{delay:.9},whileFocus:"focus",children:x.jsx(sV,{name:"details",placeholder:"Any details you'd like to add?",value:i.details,onChange:T})}),x.jsx(W.div,{initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2},variants:k,transition:{delay:1},children:x.jsxs(lV,{children:['By clicking "Submit" you hereby agree to our'," ",x.jsx("span",{onClick:S,style:{cursor:"pointer"},children:"Privacy Policy"})," ","."]})}),x.jsx(W.div,{variants:B,initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.2},transition:{delay:1.1},whileHover:"hover",whileTap:"tap",children:x.jsx(oV,{type:"submit",children:"Submit"})})]})}),x.jsx(Yv,{children:f&&x.jsx(nV,{type:f.type,message:f.message,onClose:()=>h(null)})})]})," ",p&&x.jsx(lb,{onClick:A,children:x.jsxs(cb,{onClick:H=>H.stopPropagation(),children:[x.jsx(ub,{onClick:A,children:"×"}),x.jsx(db,{})]})})]})},aV=M.form`
  display: flex;
  flex-direction: column;
  gap: 20px;
  width: 100%;
...
`,Xx=()=>x.jsx(x.Fragment,{children:x.jsxs(JH,{id:"hero",children:[x.jsx(WV,{}),x.jsx(Vb,{}),x.jsx(QH,{}),x.jsx(Rb,{}),x.jsx(FH,{}),x.jsx(kb,{}),x.jsx(C2,{}),x.jsx(KV,{}),x.jsx(S2,{})]})}),ez=M.div`
  width: 100%;
  min-height: 100vh;
  margin: 0 auto;
  padding: 0 16px;
...
`);return x.jsx(W.div,{variants:BN,initial:"hidden",animate:"visible",exit:"exit",style:{y:c,opacity:f},children:x.jsxs(TN,{id:"ap",children:[x.jsx(W.div,{variants:IN,whileHover:"hover",whileTap:"tap",children:x.jsx(AN,{to:"/tips",children:"← Back to Tips"})}),x.jsx(W.div,{variants:UN,children:x.jsx(EN,{children:a.title})}),x.jsx(W.div,{variants:$N,children:x.jsx(MN,{src:a.image,alt:a.title})}),x.jsx(W.div,{variants:GN,children:x.jsx(jN,{children:h.map((p,g)=>x.jsxs(W.div,{custom:g,variants:qN,initial:"hidden",animate:"visible",children:[x.jsx(ON,{dangerouslySetInnerHTML:{__html:p}}),g<h.length-1&&x.jsx(x.Fragment,{children:x.jsx("br",{})})]},g))})}),x.jsx(W.div,{initial:{opacity:0,y:50},animate:{opacity:1,y:0},transition:{duration:.8,delay:.6},children:x.jsx(NN,{})})]})})},FN=M.div`
  width: 100%;
  min-height: 100vh;
  margin: 0 auto;
  padding: 0 16px;

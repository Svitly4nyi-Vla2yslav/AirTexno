...
`;const KR=T.img`
  ...
  filter: ${({$overlayOpen:e,$darkMode:t})=>e||t?"brightness(1) saturate(100%)":"brightness(1) invert(1)"};
  ...
  &:active {
    transform: ${({$isOpen:e})=>e?"rotate(180deg) scale(0.95)":"rotate(0deg) scale(0.95)"};
  }
`,QR=T(ie.div)`
  padding-left: 20px;
  overflow: hidden;
...
`,pb="data:image/svg+xml,%3csvg%20width='20'%20height='20'%20viewBox='0%200%2015%2015'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M4%207L8%2011L12%207'%20stroke='white'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/svg%3e",aL=T.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  min-width: 100vw;
...
`,cL=T.p`
  ...
  line-height: 1.2em;
  width: fit-content;
`,uL={open:{rotate:45,y:8},closed:{rotate:0,y:0}},dL={open:{opacity:0},closed:{opacity:1}},fL={open:{rotate:-45,y:-8},closed:{rotate:0,y:0}},pL={open:{opacity:1,x:0},closed:{opacity:0,x:"-100%"}},hL={open:{opacity:1,height:"auto",transition:{duration:.3,ease:Um}},closed:{opacity:0,height:0,transition:{duration:.3,ease:Um}}},mL=({isOpen:e,setIsOpen:t})=>{const[i,a]=N.useState(!1),o=ia(),[c]=N.useState(!1),f=["/contact","/service","/tips","/pricing","/fridge","/dryer"].some(S=>o.pathname.startsWith(S));N.useEffect(()=>(document.body.style.overflow=e?"hidden":"auto",()=>{document.body.style.overflow="auto"}),[e]);const p=()=>{t(!1),a(!1)},h=S=>{S.preventDefault(),S.stopPropagation(),a(!i)},x=S=>{const E=o.pathname;return S==="/home#hero"?E==="/"||E==="/home":E.startsWith(S.split("#")[0])},y=i||c,b=[{to:"/home#hero",label:"Home"},{to:"/service#all",label:"Services",isService:!0,subItems:[{to:"/fridge#ap",label:"Refrigerator Repair"},{to:"/dryer#ap",label:"Dryer Repair"}]},{to:"/about#ap",label:"About Us"},{to:"/tips#app",label:"Tips"},{to:"/contact#ap",label:"Contact"}];return m.jsxs(tL,{children:[m.jsxs(nL,{onClick:()=>t(!e),"aria-label":e?"Close menu":"Open menu",children:[m.jsx(Ox,{$isOpen:e,$darkMode:f,animate:e?"open":"closed",variants:uL}),m.jsx(Ox,{$isOpen:e,$darkMode:f,animate:e?"open":"closed",variants:dL}),m.jsx(Ox,{$isOpen:e,$darkMode:f,animate:e?"open":"closed",variants:fL})]}),m.jsx(Ym,{children:e&&m.jsxs(iL,{initial:"closed",animate:"open",exit:"closed",variants:pL,transition:{duration:.3},children:[b.map((S,E)=>{const A=x(S.to);return S.isService&&S.subItems?m.jsxs(XR,{onMouseEnter:()=>a(!0),onMouseLeave:()=>a(!1),children:[m.jsxs(ZR,{children:[m.jsx(Z5,{to:S.to,onClick:p,children:m.jsx(X5,{$active:A,children:S.label})}),m.jsx(KR,{src:pb,alt:"▼",$overlayOpen:y,$darkMode:f,$isOpen:i,onClick:h,className:"arrow-button"})]}),m.jsx(Ym,{children:i&&m.jsx(QR,{initial:"closed",animate:"open",exit:"closed",variants:hL,children:S.subItems.map((k,_)=>m.jsx(JR,{children:m.jsx(eL,{to:k.to,onClick:p,className:x(k.to)?"active":"",children:k.label})},_))})}),m.jsx(K5,{})]},E):m.jsxs("div",{children:[m.jsx(Z5,{to:S.to,onClick:p,children:m.jsx(X5,{$active:A,children:S.label})}),m.jsx(K5,{})]},E)}),m.jsxs(aL,{children:[m.jsxs(Q5,{children:[m.jsx(Eo,{children:"Refrigerator Repair"}),m.jsx(Eo,{children:"Dryer Repair"}),m.jsx(Eo,{children:"Oven Repair"}),m.jsx(Eo,{children:"Range & Stove Repair"})]}),m.jsxs(Q5,{children:[m.jsx(Eo,{children:"Washer Repair"}),m.jsx(Eo,{children:"Dishwasher Repair"}),m.jsx(Eo,{children:"Cooktop Repair"}),m.jsx(Eo,{children:"Built-in and High-End Brands Repair"})]})]}),m.jsxs(rL,{children:[m.jsx(sL,{}),m.jsxs(oL,{children:[m.jsx(lL,{children:"Designed by TRBN"}),m.jsx(cL,{children:"Copyright © 2025 Airtexno - All Rights Reserved."})]})]})]})})]})},gL="/assets/LogoandTextContainer-CnBPFIWK.svg",xL=T.div`
  position: relative;
  min-width: 100vw;
  min-height: 100vh;
  overflow: auto;
...
`,zD="/assets/photo_2025-09-16_22-58-10-Bd-7i7_Y.jpg",lw="/assets/Review%20Image%201-BysFOq9G.png",HD="/assets/photo_2025-09-16_22-58-06-Byl6jOLf.jpg",VD="/assets/photo_2025-09-16_22-58-01-CZJ1euxS.jpg",_D="/assets/photo_2025-09-16_22-58-19-CMYu6dTK.jpg",ND="/assets/photo_2025-09-16_22-57-47-BZW9LnVG.jpg",PD="/assets/photo_2025-09-16_22-58-14-BefjFQXO.jpg",BD=sA`
  * {
    box-sizing: border-box;
  }

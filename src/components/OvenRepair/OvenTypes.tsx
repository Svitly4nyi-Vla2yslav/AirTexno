...
import image4 from '../../assets/icons/Oven/Thermador Combination Oven.png';
import image5 from '../../assets/icons/Oven/LGElectricWallOven.png';
...
const slides = [
  {
    img: image1,
    title: 'KitchenAid Double Wall Oven',
    description:
      'Popular for large families and heavy cooking, but often face issues with uneven baking, faulty thermostats, or control board failures. We repair heating problems and restore accurate temperature.',
  },
  {
    img: image2,
  ...
  {
    img: image3,
    title: 'Wolf Gas Range Oven',
    description:
      'Luxury gas ovens are powerful but can develop ignition failures, gas leaks, or burners that won’t light. Our experts handle igniter replacement and safety checks for reliable cooking.',
  },
  {
    img: image4,
    title: 'Thermador Combination Oven',
    description:
      'Combination ovens (oven + microwave) are convenient but prone to microwave malfunctions, broken touch panels, or oven not heating. We’ll fix both units and keep your kitchen running.',
  },
  {
    img: image5,

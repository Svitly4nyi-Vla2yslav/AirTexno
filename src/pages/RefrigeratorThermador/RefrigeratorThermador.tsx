...
import image1 from '../../assets/brands/refrigerator/thermador/r_the_01.jpg';
import image2 from '../../assets/brands/refrigerator/thermador/r_the_02.jpg';

const RefrigeratorThermador: React.FC = () => {
  return (
    <Container id='ap'>
      <RefrigeratorBrandHero 
        brandName="Thermador"
        description="If your Thermador refrigerator is not cooling, leaking water, making unusual noise, or showing error codes, you need accurate diagnostics—not guesswork. At Airtexno Appliance Repair, we specialize in Thermador refrigerator and freezer repair with a technician-first approach: confirm the root cause, explain it clearly, and repair it for long-term reliability."
        image1={image1}
        image2={image2}
      />
      <Partners />
      ...
      <RefrigeratorBrandFAQ
        ...
        faqData={[
          ...
          { question: "Is it worth repairing a Thermador refrigerator?", answer: "In many cases, yes\u2014especially for built-in installations. Many failures can be repaired cost-effectively once the root cause is confirmed." },
...
export default RefrigeratorThermador;
